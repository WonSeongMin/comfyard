...
public class FriendList extends CustomActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		btnSetting.setOnClickListener(new Button.OnClickListener() {
			...
			@Override
			public void onClick(View v){
				Intent intent = new Intent(FriendList.this, Setting.class);
				startActivity(intent);
			}
		});

		btnPeopleList.setOnClickListener(new Button.OnClickListener() {

			@Override
			public void onClick(View v){
				Intent intent = new Intent(FriendList.this, UserList.class);
				startActivity(intent);
			}
		});
	}
